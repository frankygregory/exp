...
function changeMonth(datepickerElement, currentYear, currentMonth, settings) {
  ...
  if (settings.disableDateBefore) {
      var beforeMonth = settings.disableDateBefore.getMonth();
      var beforeYear = settings.disableDateBefore.getFullYear();
  ...
  if (settings.disableDateAfter) {
      var afterMonth = settings.disableDateAfter.getMonth();
      var afterYear = settings.disableDateAfter.getFullYear();
...
function datepickerAssignDate(date, settings) {
