...
<head>
	...
	<link href="<?=base_url()?>assets/panel/css/default.css?v=2" rel="stylesheet">
	<link href="<?=base_url()?>assets/template/css/top.css?v=1" rel="stylesheet" media="(orientation: landscape)">
	<link href="<?=base_url()?>assets/template/css/top - portrait.css" rel="stylesheet" media="(orientation: portrait)">
	<link href="<?=base_url()?>assets/panel/css/<?= $pageName ?>.css?v=8" rel="stylesheet">
