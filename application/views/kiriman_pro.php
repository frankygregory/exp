...
var getAllStatusKirimanUrl = "<?php echo base_url("kiriman-saya-bisnis/getAllStatusKiriman"); ?>";
var getDetailPengirimUrl = "<?php echo base_url("kiriman-saya-bisnis/getInfoEkspedisi"); ?>";
var cancelShipmentUrl = "<?php echo base_url("kiriman-saya-bisnis/cancelShipment"); ?>";
var submitRatingUrl = "<?php echo base_url("kiriman-saya-bisnis/submitRating"); ?>";
var getKirimanCountUrl = "<?php echo base_url("kiriman-saya-bisnis/getKirimanCount"); ?>";
...
<script src="<?php echo base_url("assets/panel/js/kiriman_pro.js"); ?>" defer></script>