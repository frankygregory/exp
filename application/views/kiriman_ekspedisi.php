...
var getAllStatusKirimanUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getAllStatusKiriman"); ?>";
var getDetailPengirimUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getDetailPengirim"); ?>";
var cancelShipmentUrl = "<?php echo base_url("kiriman-darat-ekspedisi/cancelShipment"); ?>";
var getKendaraanUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getKendaraan"); ?>";
var getSupirUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getSupir"); ?>";
var getAlatUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getAlat"); ?>";
var submitTerimaUrl = "<?php echo base_url("kiriman-darat-ekspedisi/submitTerima"); ?>";
var submitAmbilUrl = "<?php echo base_url("kiriman-darat-ekspedisi/submitAmbil"); ?>";
var submitKirimUrl = "<?php echo base_url("kiriman-darat-ekspedisi/submitKirim"); ?>";
var submitPesanUrl = "<?php echo base_url("kiriman-darat-ekspedisi/submitPesan"); ?>";
var submitDealUrl = "<?php echo base_url("kiriman-darat-ekspedisi/submitDeal"); ?>";
var getKirimanCountUrl = "<?php echo base_url("kiriman-darat-ekspedisi/getKirimanSaya"); ?>";
