...
var getKotaUrl = "<?php echo base_url("cari-kiriman-bisnis/getKota"); ?>";
var getKirimanUrl = "<?php echo base_url("cari-kiriman-bisnis/getKirimanPro"); ?>";
...
<script src="<?php echo base_url("assets/panel/js/kirim_pro.js"); ?>" defer></script>