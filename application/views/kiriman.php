...
function getAllStatusKiriman(tr, element) {
	...
	ajaxCall("<?= base_url("kiriman-saya/getAllStatusKiriman") ?>", {shipment_id: shipment_id}, function(json) {
...
function addKirimanToTable(result, tabsNumber, tab) {
	...
	$(".tabs-content[data-tabs-number='" + tabsNumber + "'] .tbody-kiriman").html(element[tab]);
}
</script>