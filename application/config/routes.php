...
$route['api/answer-location-request'] = 'api/answer_location_request';
$route['api/update-firebase-token'] = 'api/update_firebase_token';
...
$route["alat/getAlatLocationFromRequest"] = "panel/alat/getAlatLocationFromRequest";
...
$route['user/getUserPending'] = 'panel/user/getUserPending';
...
$route['user/cancelPending'] = 'panel/user/cancelPending';
