...
class Kirim extends MY_Controller
{
	...
	private function detail_umum($id) {
		...
		$data = array(
			...
			'additional_file' => '<link href="' . base_url() . 'assets/panel/css/default.css" rel="stylesheet"><link href="' . base_url() . 'assets/panel/css/kirimbarang_detail.css?v=2" rel="stylesheet">',
